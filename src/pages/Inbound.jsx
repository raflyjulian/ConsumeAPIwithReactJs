        ...
        return (
            <Case>
                <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
                    <Link to={'/inbound-stuffs/data'} className="inline-flex items-center px-4 py-2 text-sm ml-3 font-medium text-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mb-5 mr-3 rounded-lg">
                            Data
                    </Link>
                            <h2 class="mb-4 text-xl font-bold text-white dark:text-white">Add a new Inbound Stuff Data</h2>
                            {
                                alert ? (
                                    <div className="p-4 mb-4 text-sm text-green-800 roundel-lg bg-green-50 dark:bg-gray-800 dark:text-green-400" role="alert">
